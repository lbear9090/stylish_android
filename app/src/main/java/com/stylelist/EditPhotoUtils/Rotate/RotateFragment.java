package com.stylelist.EditPhotoUtils.Rotate;
...
public class RotateFragment extends Fragment implements TwoLineSeekBar.OnSeekChangeListener, View.OnClickListener {
    ...
    private boolean isRotateChanged = false;

    public static RotateFragment newInstance(String inputUrl, OnRotateListener onRotateListener) {
