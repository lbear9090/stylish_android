package com.stylelist.EditPhotoUtils.Brightness;
...
public class BrightnessFragment extends Fragment implements View.OnClickListener, TwoLineSeekBar.OnSeekChangeListener {
    ...
    private boolean isBrightChanged = false;

    public static BrightnessFragment newInstance(String inputUrl, OnBrightnessListener onBrightnessListener) {
