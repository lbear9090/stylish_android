package com.stylelist.EditPhotoUtils.Contrast;
...
public class ContrastFragment extends Fragment implements View.OnClickListener, TwoLineSeekBar.OnSeekChangeListener {
    ...
    private boolean isContrastChanged = false;
    private EditPhotoActivity editPhotoActivity;

    public static ContrastFragment newInstance(String inputUrl, OnContrastListener onContrastListener) {
