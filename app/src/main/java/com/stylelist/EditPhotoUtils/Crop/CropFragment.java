...
//
//    public static CropFragment newInstance(Bitmap inputUrl, OnCropListener onCropListener) {
...
//                    onCropListener.onCropPhotoCompleted(Utils.getBitmapSdcard(resultUri.getPath()));
//                back();
//            }
//
//            @Override
